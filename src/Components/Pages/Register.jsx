...
const Register = () => {
  ...
  return (
    <div className="flex justify-center items-center max-w-8xl py-10 mx-auto min-h-screen px-4 sm:px-6 lg:px-8">
      <div className="w-1/2 flex flex-col items-end">{!loggedUser ? <RegistrationForm /> : <p className="w-full text-center text-2xl font-bold">You are Already logged in</p>}</div>
